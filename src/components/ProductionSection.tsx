      ...
      <div className="w-full max-w-7xl mx-auto px-6 md:px-12 flex-1 flex flex-col justify-between pt-20 pb-2 md:pt-24 md:pb-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-stretch flex-grow max-h-[460px] md:max-h-[500px] lg:max-h-[520px] xl:max-h-[560px] max-w-5xl mx-auto w-full mb-3 md:mb-4">
          ...
          <motion.div
            ...
            className="bg-[#3E5F8A] rounded-[2.5rem] pt-5 px-6 pb-4 md:pt-6 md:px-8 md:pb-5 flex flex-col justify-between text-[#FAF5EF] relative overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 bg-cover bg-center bg-no-repeat w-full max-w-[400px] justify-self-center h-full"
            style={{ backgroundImage: "url('/brand/slate_blue_texture.webp')" }}
          >
            {/* Header Title */}
            <div className="text-center mb-1 select-none">
              <h2 className="font-unbounded text-sm md:text-base lg:text-lg font-black tracking-tight border-b border-[#FAF5EF]/20 pb-1.5 w-full">
              ...
              <AnimatePresence mode="wait">
                {!isSubmitted ? (
                  <motion.form
                    ...
                    className="flex flex-col gap-2 md:gap-3 text-left"
                  >
                    {/* Field 1: Name */}
                    <div>
                      <label className="text-[9px] md:text-[10px] text-[#B58E45] font-space font-bold uppercase tracking-wider mb-0.5 block select-none">
                      ...
                      <input 
                        ...
                        className="w-full bg-transparent border border-[#FAF5EF]/45 rounded-full px-4 py-1 text-[11px] md:text-[12px] text-[#FAF5EF] focus:outline-none focus:border-[#FAF5EF] placeholder-[#FAF5EF]/20 font-outfit"
                        placeholder="..."
                      />
                    </div>
                    ...
                    <button 
                      ...
                      className="bg-[#2E4A72] hover:bg-[#203554] disabled:opacity-50 text-white font-unbounded text-[10px] md:text-[11px] font-black uppercase py-2 px-8 rounded-full cursor-pointer transition-all active:scale-95 shadow-md w-full max-w-[180px] mx-auto select-none focus:outline-none mt-2"
                    >
