    ...
    >
      ...
      <div className="relative flex-grow flex-1 w-full max-w-7xl mx-auto px-6 md:px-12 pt-20 pb-20 md:pt-24 md:pb-24 z-10 flex flex-col justify-between overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center h-full w-full">
          ...
          <div className="lg:col-span-7 xl:col-span-8 flex flex-col justify-between h-full py-4 text-left">
            
            {/* Title */}
            <div className="relative z-10 mt-2">
              <motion.h1 
                className="font-unbounded text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-[#B58E45] tracking-tight uppercase select-none drop-shadow-[0_4px_8px_rgba(0,0,0,0.15)]"
            ...
            {/* Products Row */}
            <div className="flex items-end gap-6 md:gap-10 lg:gap-12 xl:gap-16 w-full mt-auto mb-4 select-none">
              ...
              >
                <div className="w-[100px] md:w-[125px] h-[170px] md:h-[200px] bg-white border border-[#3E5F8A]/40 rounded-[2.5rem] p-3 flex flex-col items-center justify-between shadow-md hover:shadow-lg transition-all duration-300">
                  <img 
                    src="/brand/wc_keychain.png" 
                    alt="Llaveros" 
                    className="h-[110px] md:h-[130px] w-auto object-contain pointer-events-none select-none filter contrast-[1.05] saturate-[1.1]"
                  />
                  <span className="font-unbounded text-[9px] md:text-[10px] font-black text-[#3E5F8A] tracking-wider uppercase mb-1">
              ...
              >
                <div className="h-[210px] md:h-[260px] lg:h-[280px] xl:h-[310px] flex items-end justify-center">
                  <img 
                ...
                <span className="font-unbounded text-[10px] md:text-[11px] font-black text-white tracking-widest uppercase mt-3">
          ...
          {/* Right Column: Symmetrical Info Card with Messi outside overlapping dynamically */}
          <div className="lg:col-span-5 xl:col-span-4 flex flex-col items-center justify-center h-full py-4 relative z-10">
            
            {/* Symmetrical Floating Card */}
            <motion.div 
              className="w-full max-w-[380px] lg:max-w-[420px] h-[80%] sm:h-[82%] md:h-[85%] lg:h-[87%] bg-white border border-[#3E5F8A]/10 rounded-[3rem] shadow-xl p-6 md:p-8 flex flex-col justify-start items-center relative overflow-hidden backdrop-blur-sm bg-white/95 mb-10 md:mb-14 lg:mb-16"
              initial={{ opacity: 0, scale: 0.96 }}
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
              transition={{ duration: 0.8, ease: "easeOut" }}
            >
              {/* Card Header with real soccer ball SVG */}
              <div className="flex items-center justify-center w-full select-none border-b border-[#3E5F8A]/5 pb-3">
                <svg className="w-8 h-8 text-[#3E5F8A] animate-[spin_40s_linear_infinite]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                  <circle cx="12" cy="12" r="10" />
                  <polygon points="12,9 15,11.5 14,15.5 10,15.5 9,11.5" strokeLinejoin="round" />
                  <line x1="12" y1="9" x2="12" y2="2" />
                  <line x1="15" y1="11.5" x2="21" y2="10" />
            ...
            {/* Messi Overlay raising the trophy - outside the card, starting from screen bottom, overlapping card z-20 */}
            <motion.img 
